              ...
              <ul className="custom-list">
                ...
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">khaleelr4@gmai.com</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content"><a href="https://www.linkedin.com/in/muhammad-khalil-ur-rehman-031643b0/" className="text-light" target="_blank" rel="noopener noreferrer">Muhammad Khalil Ur Rehman</a></span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    <span className="contact-title">Fiverr </span>
                    <i className="fa fa-user-o" />
                    <span className="contact-content"><a href="https://www.fiverr.com/khaleel007711?public_mode=true" className="text-white" target="_blank" rel="noopener noreferrer">@khaleel007711</a></span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    <span className="contact-title">Up Work</span>
                    <i className="fa fa-user-o" />
                    <span className="contact-content"><a href="https://www.upwork.com/freelancers/~018c6dd3ae4b20760b" className="text-white" target="_blank" rel="noopener noreferrer">@khaleel007711</a></span>
                  </h6>
                </li>
              </ul>
